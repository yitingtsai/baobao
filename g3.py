...
from struct import * 
debug=0
# work for pms3003 data structure: 
# https://github.com/avaldebe/AQmon/blob/master/Documents/PMS3003_LOGOELE.pdf fix me: the 
# format is different between /dev/ttyUSBX(USB to Serial) and /dev/ttyAMA0(GPIO RX)
#          ttyAMA0:0042 004d 0014 0022 0033 ttyUSB0:4d42 1400 2500 2f00
class g3sensor():
    def __init__(self):
        if debug: print "init"
